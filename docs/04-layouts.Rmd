...
<br>
<br>
`r 'Ao RStudio: 10-exemplo-html.html'`
<center>
...
<center>
<img src="img/gridsystem.jpg" width = 50%>
<br>
...
Para criar colunas dentro de uma linha, utilizamos a função `column()`. Essa função tem dois argumentos: `width` e `offset`. O primeiro determina o comprimento da coluna (de 1 a 12). O segundo indica quanto espaço horizontal para  "pular" antes de começar a nossa coluna.

<center>
<img src="img/gridsystem2.png" width = 70%>
<br>
...
<br>
<br>
`r ('Ao RStudio: 12-sidebarLayout.R')`
<center>
