...
**Valores reativos** são aqueles que podem mudar de valor conforme ações vindas da UI. **Funções reativas** são funções que recebem valores reativos e, portanto, são recalculadas sempre que um valor reativo muda.

Valores reativos só podem ser usados dentro de funções reativas ou em um **contexto reativo**.
